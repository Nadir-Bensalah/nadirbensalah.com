...
const columns = [
  {
    title: 'The work',
    links: [
      { label: 'Apps on the App Store', href: '/en/apps' },
      { label: 'Native iOS modules', href: '/en/ios-native-modules' },
      { label: 'Code audit', href: '/en/react-native-audit' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'How I work', href: '/en/about' },
      { label: 'Get in touch', href: '/en/contact' },
      { label: 'Download CV', href: '/assets/cv/cv-nadir-ben-salah.pdf' },
    ],
  },
];
      ...
      <div className="enveloppe">
        ...
        >
          <p className="t-petit t-3">
            © {new Date().getFullYear()} {profileEn.name} · {profileEn.city}, {profileEn.country}
          </p>
